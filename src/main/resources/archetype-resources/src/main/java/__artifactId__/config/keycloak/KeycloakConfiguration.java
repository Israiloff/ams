...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${artifactId}.config.keycloak;
...
public class KeycloakConfiguration {
	...
	@Bean
	Converter<Jwt, Collection<GrantedAuthority>> keycloakGrantedAuthoritiesConverter(@Value("${symbol_dollar}{keycloak.security.clientId}") String clientId) {
